...
const OutbreakPrediction = () => {
    ...
    if (isLoading) {
        return <div className="min-h-screen bg-[#091E1E] flex items-center justify-center text-teal-400 animate-pulse">Running AI Prediction Models...</div>;
    }

    return (
        <div className="min-h-screen font-sans bg-gradient-to-br from-[#091E1E] to-[#113030] text-white p-6 pb-20 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div className="lg:col-span-2 bg-white/5 border border-white/10 rounded-3xl p-6 hover:border-white/20 transition-colors">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="flex bg-[#091E1E] rounded-lg p-1 border border-white/10">
                        ...
                        <div className="h-[300px] w-full min-h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={trendData}>
                                    ...
                                    <Tooltip
                                        contentStyle={{ backgroundColor: '#091E1E', borderColor: '#ffffff20', color: '#fff', borderRadius: '8px' }}
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                {multiFactorView === 'Bar' ? (
                                    <BarChart data={multiFactorData}>
                                        ...
                                        <XAxis dataKey="date" stroke="#6b7280" tick={{ fontSize: 12 }} axisLine={false} tickLine={false} dy={10} />
                                        <YAxis stroke="#6b7280" tick={{ fontSize: 12 }} axisLine={false} tickLine={false} dx={-10} />
                                        <Tooltip contentStyle={{ backgroundColor: '#091E1E', borderColor: '#ffffff20', borderRadius: '8px' }} cursor={{ fill: '#ffffff05' }} />
                                    ...
                                    <LineChart data={multiFactorData}>
                                        ...
                                        <XAxis dataKey="date" stroke="#6b7280" tick={{ fontSize: 12 }} axisLine={false} tickLine={false} dy={10} />
                                        <YAxis stroke="#6b7280" tick={{ fontSize: 12 }} axisLine={false} tickLine={false} dx={-10} />
                                        <Tooltip contentStyle={{ backgroundColor: '#091E1E', borderColor: '#ffffff20', borderRadius: '8px' }} />
