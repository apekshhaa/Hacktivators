...
const AdminHome = () => {
    ...
    return (
        <div className="min-h-screen font-sans bg-gradient-to-br from-[#091E1E] to-[#113030] text-white overflow-y-auto relative">
                ...
                <div className="flex flex-col h-full justify-between gap-6 pb-6">
                    ...
                    <div className="bg-gradient-to-br from-accent/10 to-transparent border border-accent/20 p-8 rounded-3xl flex-1 min-h-[350px] flex flex-col justify-center relative overflow-hidden group hover:border-accent/40 transition-colors">
                        ...
                        <button
                            ...
                            className="bg-accent text-[#091E1E] py-3 px-6 rounded-xl font-bold hover:bg-accent/90 transition-all shadow-[0_0_20px_rgba(209,240,114,0.2)] text-sm"
                        >
                            Manage Rewards
                        </button>
                    </div>
                    ...
                    <div className="bg-[#0f2828] border border-white/20 rounded-2xl p-8 max-w-3xl w-full shadow-2xl relative my-8">
                        ...
                        {formSuccess ? (
                            ...
                            <form onSubmit={handleFormSubmit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className="bg-accent text-[#091E1E] px-4 py-3 rounded-xl font-bold hover:bg-accent/90 transition-all flex items-center justify-center"
                                            >
                                                <Plus size={20} />
                                            </button>
                                        </div>
                                ...
                                <div className="border-t border-white/10 pt-6">
                                    ...
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                                        ...
                                        <button
                                            ...
                                            className="mt-4 bg-accent text-[#091E1E] px-4 py-2 rounded-lg font-bold hover:bg-accent/90 transition-all text-sm"
                                        >
                                            Add Member
                                        </button>
                                    </div>
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-accent text-[#091E1E] font-bold py-3 rounded-xl hover:bg-accent/90 transition-all mt-4"
                                >
